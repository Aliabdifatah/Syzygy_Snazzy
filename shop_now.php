...
<section class="py-5 bg-light text-center">
    <div class="container">
        <h2 class="mb-4 text-primary text-dark">PRODUCTS</h2>
        <hr>
        ...
        <div class="row g-4 mt-4 justify-content-center">
            ...
            <div class="col-md-4">
                <div class="card shadow-sm p-4 text-center">
                    ...
                    <a href="checkout.php?product_id=22" class="btn btn-danger">Buy Now</a>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm p-4 text-center">
                    <img src="images/cloud security.jpeg" alt="Cloud Security" class="img-fluid mb-3" style="width: 80px;">
                    <h3 class="h5">Cloud Backup</h3>
                    <p class="text-muted">Top-notch security features to protect your data.</p>
                    <a href="checkout.php?product_id=23" class="btn btn-danger">Buy Now</a>
